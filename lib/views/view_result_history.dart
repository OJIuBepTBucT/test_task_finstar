...
//                   title: Text(
//
//                     "Loan Amount: ${history.loanAmount}, Interest Rate: ${history.interestRate}%, Loan Term: ${history.loanTerm} months",
//
//                     style: TextStyle(fontFamily: 'SFProText', fontSize: 16),
//
//                   ),
...
//
//           content: Text("Are you sure you want to clear all calculation history?"),
//
//           actions: [
//
//             TextButton(
